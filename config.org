...
* dzungt
** Taking away from [[https://github.com/doomemacs/doomemacs][doom]]
#+begin_src emacs-lisp
(use-package general
  :ensure t
  )
...
#+BEGIN_SRC emacs-lisp
  (use-package org-roam
    ...
    :config
    (setq
     org-roam-db-location (concat org-roam-directory "/para.db")
     org-roam-capture-templates
     '(("r" "default / resource" plain "%?"
        :target (file+head "%(expand-file-name org-roam-directory)/resource/%<%Y%m%d>-%<%H%M%S>.org"
                           "#+title:   ${title}\n"
                           )
        :unnarrowed t)

       ("a" "area" plain "%?"
        :target (file+head "%(expand-file-name org-roam-directory)/area/%<%Y%m%d>-%<%H%M%S>.org"
                           "#+title:   ${title}\n"
                           )
        :unnarrowed t)

       ("p" "project" plain "%?"
        :target (file+head "%(expand-file-name org-roam-directory)/project/%<%Y%m%d>.org"
                           "#+title:   ${title}\n"
                           )
        :unnarrowed t)

       ("b" "bib / contact" plain "%?"
        :target (file+head "%(expand-file-name org-roam-directory)/bib/%<%Y%m%d>-%<%H%M%S>.org"
                           "#+title:   ${title}\n"
                           )
        :unnarrowed t)
       )
